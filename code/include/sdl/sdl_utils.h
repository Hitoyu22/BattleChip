...
/**
 * Resize l'image en fonction de la taille de l'écran
 * @param renderer : le renderer
 * @param src : la texture
 * @param new_w : nouvelle width pour la texture
 * @param new_h : nouvelle height pour la texture
 */
